        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <div className="space-y-2">
            ...
            <Input
              ...
              {...register('name')}
              className={`h-11 bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700 focus:border-[var(--mulearn-trusty-blue)] focus:ring-1 focus:ring-[var(--mulearn-trusty-blue)] transition-all ${errors.name ? 'border-red-500' : ''}`}
            />
            {errors.name && (
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              {...register('email')}
              className={`h-11 bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700 focus:border-[var(--mulearn-trusty-blue)] focus:ring-1 focus:ring-[var(--mulearn-trusty-blue)] transition-all ${errors.email ? 'border-red-500' : ''}`}
            />
            {errors.email && (
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              {...register('phone')}
              className={`h-11 bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700 focus:border-[var(--mulearn-trusty-blue)] focus:ring-1 focus:ring-[var(--mulearn-trusty-blue)] transition-all ${errors.phone ? 'border-red-500' : ''}`}
            />
            {errors.phone && (
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              maxLength={10}
              className={`h-11 bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700 focus:border-[var(--mulearn-trusty-blue)] focus:ring-1 focus:ring-[var(--mulearn-trusty-blue)] transition-all ${errors.panNumber ? 'border-red-500' : ''}`}
            />
            {errors.panNumber && (
        ...
        {isOrganisation && (
          <div className="space-y-2 animate-in fade-in duration-200">
            ...
            <Input
              ...
              className={`h-11 bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700 focus:border-[var(--mulearn-trusty-blue)] focus:ring-1 focus:ring-[var(--mulearn-trusty-blue)] transition-all ${errors.organisationName ? 'border-red-500' : ''}`}
            />
