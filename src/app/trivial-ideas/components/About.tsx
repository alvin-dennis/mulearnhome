        ...
        <div className="flex flex-col items-center gap-12">
          <div className="max-w-3xl text-center">
            ...
            >
              <p className="text-2xl md:text-3xl lg:text-5xl  font-bold">
                Work On Ideas That <span className="text-mulearn-trusty-blue">Excite</span> You
              </p>
            </MotionDiv>
            <MotionDiv
              initial={{ opacity: 0, y: 40 }}
          ...
          >
            <div className="grid grid-cols-2 md:grid-cols-4 gap-9">
              <Card variant="interactive" className="bg-mulearn-trusty-blue text-mulearn-whitish">
              ...
              <Card
                variant="interactive"
                className="bg-mulearn-trusty-blue text-mulearn-whitish flex flex-center justify-center flex-col"
              >
