          ...
          >
            <div className="relative w-full max-w-sm lg:max-w-xl h-80">
              ...
              <MotionDiv
                ...
                className="absolute top-40 left-45 w-12 h-12 bg-white rounded-lg shadow-lg p-2"
              >
              ...
              <MotionDiv
                ...
                className="absolute top-70 right-62 w-12 h-12 bg-white rounded-lg shadow-lg p-2"
              >
              ...
              <MotionDiv
                ...
                className="absolute bottom-4 left-36 w-12 h-12 bg-white rounded-lg shadow-lg p-2"
              >
              ...
              <MotionDiv
                ...
                className="absolute -bottom-20 right-80 w-12 h-12 bg-white rounded-lg shadow-lg p-2"
              >
