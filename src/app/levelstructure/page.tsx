...
export default function LevelStructure() {
  ...
  // Handle journey begin with super animation
  const handleBeginJourney = () => {
    setIsAnimating(true);
    // Wait for button animation to complete before showing welcome
    setTimeout(() => {
      setShowWelcome(true);
  ...
  // Add space animations for white background and level progression
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen">
      <AnimatePresence mode="wait">
        ...
        {/* Static Floating Rocks Background */}
        <div className="absolute inset-0 pointer-events-none z-0">
          {/* Small Rocks - Top Left */}
          <div className="absolute top-16 left-8 rock-static" style={{ animationDelay: '0s' }}>
            <MuImage
              src={smallRocks}
              alt="Small Rocks"
              width={60}
          ...
          {/* Stone - Top Right */}
          <div className="absolute top-24 right-16 rock-static" style={{ animationDelay: '2s' }}>
            <MuImage
              src={stone}
              alt="Stone"
              width={80}
          ...
          {/* Small Rocks - Bottom Left */}
          <div className="absolute bottom-32 left-16 rock-static" style={{ animationDelay: '4s' }}>
            <MuImage
              src={smallRocks}
              alt="Small Rocks"
              width={50}
          ...
          {/* Stone - Bottom Right */}
          <div className="absolute bottom-20 right-8 rock-static" style={{ animationDelay: '1s' }}>
            <MuImage
              src={stone}
              alt="Stone"
              width={70}
          ...
          {/* Small Rocks - Middle Left */}
          <div className="absolute top-1/2 left-4 rock-static" style={{ animationDelay: '3s' }}>
            <MuImage
              src={smallRocks}
              alt="Small Rocks"
              width={55}
          ...
          {/* Stone - Middle Right */}
          <div className="absolute top-1/3 right-12 rock-static" style={{ animationDelay: '5s' }}>
            <MuImage
              src={stone}
              alt="Stone"
              width={65}
          ...
          {/* Additional Left Side Rocks - Different Positioning */}
          {/* Small Rocks - Top Left Corner */}
          <div className="absolute top-8 left-2 rock-static" style={{ animationDelay: '6s', transform: 'rotate(15deg)' }}>
            <MuImage
              src={smallRocks}
              alt="Small Rocks"
              width={45}
          ...
          {/* Stone - Left Edge Middle */}
          <div className="absolute top-2/3 left-6 rock-static" style={{ animationDelay: '7s', transform: 'rotate(-10deg)' }}>
            <MuImage
              src={stone}
              alt="Stone"
              width={75}
          ...
          {/* Small Rocks - Left Bottom */}
          <div className="absolute bottom-8 left-2 rock-static" style={{ animationDelay: '8s', transform: 'rotate(25deg)' }}>
            <MuImage
              src={smallRocks}
              alt="Small Rocks"
              width={40}
          ...
          {/* Stone - Left Upper Third */}
          <div className="absolute top-1/4 left-12 rock-static" style={{ animationDelay: '9s', transform: 'rotate(-20deg)' }}>
            <MuImage
              src={stone}
              alt="Stone"
              width={60}
          ...
          {/* Small Rocks - Far Left Center */}
          <div className="absolute top-1/2 left-0 rock-static" style={{ animationDelay: '10s', transform: 'rotate(35deg)' }}>
            <MuImage
              src={smallRocks}
              alt="Small Rocks"
              width={35}
            ...
            <div className="flex flex-col lg:flex-row md:pl-10 items-center justify-between gap-8 sm:gap-12 lg:gap-16 xl:gap-20">
              ...
              <div className="flex-1 relative flex items-center justify-center lg:order-2 order-1 px-4 sm:px-6">
                <div className="relative w-72 h-72 sm:w-80 sm:h-80 md:w-96 md:h-96 lg:w-[28rem] lg:h-[28rem] flex items-center justify-center">
                  {/* Galaxy Background */}
                  <div className="absolute inset-0 rounded-full bg-gradient-radial from-mulearn-trusty-blue/20 via-mulearn-duke-purple/10 to-transparent animate-spin" style={{ animationDuration: '20s' }} />
                  
                  {/* Central Planet SVG - Perfectly Centered */}
                  <div className="relative w-20 h-20 sm:w-24 sm:h-24 md:w-32 md:h-32 lg:w-40 lg:h-40 flex items-center justify-center">
                    <MuImage
                      ...
                      style={{ filter: 'drop-shadow(0 0 20px rgba(46, 133, 254, 0.4))' }}
                    />
                  </div>

                  {/* Orbiting Elements - Circular Paths */}
                  <div className="absolute inset-4 sm:inset-6 md:inset-8 border-2 border-mulearn-trusty-blue/30 rounded-full animate-spin" style={{ animationDuration: '15s', aspectRatio: '1' }}>
                  ...
                  <div className="absolute inset-2 sm:inset-3 md:inset-4 border-2 border-mulearn-duke-purple/25 rounded-full animate-spin" style={{ animationDuration: '25s', animationDirection: 'reverse', aspectRatio: '1' }}>
              ...
              <div className="flex-1 text-center lg:text-left space-y-6 sm:space-y-8 lg:order-1 order-2 px-4 sm:px-6 lg:px-0">
                <div>
                  <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-6xl font-bold text-mulearn-blackish mb-4 leading-tight">
                    The <span className="text-transparent bg-clip-text bg-gradient-to-r from-mulearn-trusty-blue to-mulearn-duke-purple">μLearn</span>
                    <br />
                    <span className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl">Learning Odyssey</span>
                  </h1>
                  <div className="h-1 w-24 sm:w-32 bg-gradient-to-r from-mulearn-trusty-blue to-mulearn-duke-purple lg:mx-0 mx-auto mb-6 rounded-full" />
                </div>
                ...
                <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-mulearn-gray-600 max-w-xs sm:max-w-lg md:max-w-2xl lg:mx-0 mx-auto leading-relaxed">
                  Step into an <span className="text-mulearn-trusty-blue font-semibold">unexplored universe</span> where you design your own trajectory through
                  <span className="text-mulearn-duke-purple font-semibold"> 7 levels of transformation</span>
                </p>
                ...
                <div className="mt-6 sm:mt-8">
                  <motion.button
                    ...
                    className={`bg-gradient-to-r from-mulearn-trusty-blue to-mulearn-duke-purple text-mulearn-whitish px-6 sm:px-6 py-3 sm:py-4 rounded-full font-semibold text-base sm:text-m shadow-lg shadow-mulearn-trusty-blue/25 ${
