  ...
  return (
    ...
    >
      <div className="flex-1">
        <h1 className="text-[#293338] font-semibold leading-[111.5%] mb-12 text-4xl lg:text-[4.25rem]">
          Interest Groups?
        </h1>
        <p className="text-[#293338] font-normal text-lg lg:text-xl leading-[127.5%] max-w-200 mt-8">
          Discover your passion, collaborate with like-minded individuals, and
          embark on a transformative learning journey.
        </p>
        <p className="text-[#293338] font-normal text-lg lg:text-xl leading-[127.5%] max-w-200 mt-4">
