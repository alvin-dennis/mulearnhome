  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden>
        {/* Left cluster: big sparkle + small sparkle */}
        ...
        <div className="absolute left-28 top-[63%] text-mulearn-blackish/70" style={{ transform: "rotate(10deg)" }}>
          <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
            <path d="M12 0 15 9 24 12 15 15 12 24 9 15 0 12 9 9Z" />
          </svg>
        </div>
        {/* Subtle single sparkle upper-right for balance */}
      ...
      <div className="relative mx-auto max-w-6xl px-6 pb-10 pt-16 md:pt-24">
        ...
        >
          <h1 className="font-display mx-auto max-w-4xl text-4xl font-extrabold leading-tight text-mulearn-blackish md:text-6xl">
            {/* Line 1 */}
            <span className="block">Polish your skills through</span>

            {/* Line 2: µLearn to make students */}
            <span className="relative block">
              <span className="relative inline-block align-middle text-mulearn-trusty-blue">
                µLearn
                {/* Graduation cap over µLearn */}
                <span
                  className="absolute -left-8 -top-0.5 hidden md:block"
                  style={{ transform: "rotate(-10deg)", transformOrigin: "center" }}
                >
                  <svg width="58" height="46" viewBox="0 0 120 96" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M6 32L60 10l54 22-54 22L6 32Z" fill="var(--mulearn-trusty-blue)" />
                    <path
                      d="M26 44c8 6 56 6 68 0v16c-12 10-56 10-68 0V44Z"
                      fill="var(--mulearn-trusty-blue)"
                      opacity=".35"
                    />
                    <path d="M114 32v26" stroke="var(--mulearn-trusty-blue)" strokeWidth="4" />
                    <circle cx="114" cy="60" r="5" fill="var(--mulearn-trusty-blue)" />
                  </svg>
                </span>
              </span>
              ...
              <span className="relative inline-block">
                students
                {/* Curved arrow under students from right to left (mirrored) */}
                <svg
            ...
            {/* Line 3: industry ready with student silhouette touching i */}
          ...
          <Link href="https://app.mulearn.org/" target="_blank" className="inline-block">
            <Button variant="mulearn" className="font-sans mt-8 rounded-full px-8 py-2 text-base font-semibold">
              Join µLearn
            </Button>
          </Link>
        </motion.div>
      ...
      {/* Diagonal ticker ribbon (static like reference) */}
      <div className="relative mx-auto mb-8 mt-10 h-24 w-full overflow-visible" aria-hidden="true">
        {/* Position wrapper to let the ribbon span beyond container edges */}
        <div className="absolute left-1/2 top-1/2 w-[170%] -translate-x-1/2 -translate-y-1/2">
          {/* Rotated ribbon for a diagonal accent */}
          <div className="relative mx-auto w-full" style={{ transform: "rotate(-4deg)" }}>
            {/* Blue rails (top + thicker bottom) */}
            <div
              className="absolute left-0 right-0 -top-2 h-2 rounded-full"
              style={{ backgroundColor: "var(--mulearn-trusty-blue)", boxShadow: "0 2px 8px rgba(46,133,254,0.25)" }}
            />
            <div
              className="absolute left-0 right-0 -bottom-3 h-4 rounded-full"
              style={{ backgroundColor: "var(--mulearn-trusty-blue)", boxShadow: "0 6px 14px rgba(46,133,254,0.25)" }}
            />
            ...
            >
              ...
              <svg className="h-3 w-3 text-mulearn-blackish/80 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
