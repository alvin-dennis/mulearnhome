...
const steps = [
  ...
  },
  {
    ...
    description: "Once you join the server, our bot, Aaronchetan will send you a DM asking you to connect your µ-ID, which is provided in the µlearn profile. Once it's connected, you can start your onboarding process.",
    icon: "/assets/enabler/discord.svg",
  },
  {
    number: "03",
    title: "Add Interest Groups",
    description: "Now you will have access to the #lvl1-info channel, and as you do the tasks, you will progress through the levels. Once you reach level 4, you will have the option to edit Interest Groups on your µlearn profile page.",
    icon: "💡",
  },
];
            ...
            >
              ...
              <div className="relative z-10 mb-6 flex h-24 w-24 items-center justify-center rounded-full bg-gradient-to-br from-mulearn-trusty-blue to-mulearn-duke-purple shadow-lg">
                <div className="flex h-20 w-20 items-center justify-center rounded-full bg-white">
                  {typeof step.icon === "string" && (step.icon.startsWith("/") || step.icon.startsWith("http")) ? (
                    <img
                      src={step.icon}
                      alt={`${step.title} icon`}
