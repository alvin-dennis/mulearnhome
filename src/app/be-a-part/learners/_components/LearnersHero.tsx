  ...
  return (
    <div className="relative overflow-hidden py-20 lg:py-32 ">
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
        ...
        {/* Subtitle */}
        <p className="text-bold sm:text-lg lg:text-xl text-black max-w-9xl mb-2 leading-snug px-4 whitespace-nowrap">
        ...
        {/* Tagline */}
        <p className="text-base sm:text-lg lg:text-xl text-blue-600 font-normal mb-8">
        ...
        <Button
          variant="default"
          className="bg-blue-600 hover:bg-blue-700 text-white px-10 py-6 text-lg font-semibold rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300"
          asChild
        >
