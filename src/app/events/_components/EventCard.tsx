...
export default function EventCard({ event }: Props) {
  return (
    <MotionDiv
      ...
      className={`group w-full sm:w-[380px] h-[360px]`}
    >
      <Card className="relative bg-mulearn-whitish rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-border/50 hover:border-mulearn-trusty-blue h-full flex flex-col">
        {event.image && (
