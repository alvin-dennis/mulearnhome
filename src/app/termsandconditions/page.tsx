          ...
          <li className="space-y-5">
            ...
            <ol className="list-[lower-roman] pl-6 lg:pl-8 space-y-4 text-[var(--mulearn-blackish)]">
              ...
              <li>
                ...
                names, designs, copyrights, rights of privacy and publicity and
                other forms of intellectual or industrial property, know how,
                trade secrets, any other protected rights or assets and any
                licenses and permissions in connection therewith, in each and
                every part of the world and whether or not registered or
                registrable and for the full period thereof, and all extensions
                and renewals thereof, and all applications for registration in
              ...
              <li>
                ...
                materials provided by µLearn from time to time in the course of
          ...
          <li className="space-y-5">
            ...
            <ol className="list-[lower-roman] pl-6 lg:pl-8 space-y-4 text-[var(--mulearn-blackish)]">
              ...
              <li>
                ...
                cooperate with µLearn in any investigation of such unauthorized
                uses or of infringements of µLearn’s Intellectual Property
                Rights in the Training. µLearn shall have the sole right to
                bring any action on account of such infringements or
                unauthorized uses. µLearn is in no way liable for any claims
          ...
          <li className="space-y-5">
            ...
            <ol className="list-[lower-roman] pl-6 lg:pl-8 space-y-4 text-[var(--mulearn-blackish)]">
              ...
              <li>
                ...
                authorized to:-
                <ol className="list-disc pl-6 lg:pl-8 space-y-2 mt-4">
                  <li>
              ...
              <li>
                ...
                e-learning program, and the URL https://mulearn.org/. You may
          ...
          <li className="space-y-5">
            ...
            <ol className="list-[lower-roman] pl-6 lg:pl-8 space-y-4 text-[var(--mulearn-blackish)]">
              ...
              <li>
                ...
                Terms, you will be suspended from the server and will be revoked
                from accessing other discord channels. The above listed rules in
                this Clause 5 of this Terms are not exhaustive, and our
          ...
          <li className="space-y-5">
            ...
            <ol className=" pl-6 lg:pl-8 space-y-4 text-[var(--mulearn-blackish)]">
              <li>
                ...
                and against any and all claims, liability, losses, damages,
                costs and expenses (including reasonable legal fees on a
                solicitor and client basis) incurred by us as a result of or in
                connection with any breach or alleged breach by you or anyone
                acting on your behalf of any of these Terms.
              </li>
            </ol>
          </li>
          <li className="space-y-5">
            ...
            <ol className=" pl-6 lg:pl-8 space-y-4 text-[var(--mulearn-blackish)]">
              <li>
                ...
                enemy, acts or failure to act by the other Party, acts of civil
                or military authority, governmental priorities, strikes or other
                labour disturbances, hurricanes, earthquakes, fires, floods,
                epidemics, embargoes, war, riots. In the event of any such
                delay, the date of delivery or of performance shall be extended
                for a period equal to the effect of time lost by reason of the
                delay.
              </li>
            </ol>
          </li>
          <li className="space-y-5">
            ...
            <ol className=" pl-6 lg:pl-8 space-y-4 text-[var(--mulearn-blackish)]">
              <li>
                ...
                be resolved according to the following order of priority: (i)
                the Additional Terms; (ii) the Terms; and (iii) the Terms and
          ...
          <li className="space-y-5">
            ...
            <ol className=" pl-6 lg:pl-8 space-y-4 text-[var(--mulearn-blackish)]">
              <li>
                ...
                hereof, and supersedes all prior or contemporaneous written or
                verbal agreements and understandings with you in connection
                therewith. If any provision of these Terms is held by a court of
          ...
          <li className="space-y-5">
            ...
            <ol className="pl-6 lg:pl-8 space-y-4 text-[var(--mulearn-blackish)]">
              <li>
                ...
                the Processing of Personal Data carried out by us, or on our
          ...
          <li className="space-y-5">
            ...
            <ol className="pl-6 lg:pl-8 space-y-4 text-[var(--mulearn-blackish)]">
              <li>
                ...
                Cookie Policy. When you visit our Website we may place Cookies
