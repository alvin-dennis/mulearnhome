...
const LearnersHero = () => {
  return (
    <div className="relative overflow-hidden pt-20 pb-48 lg:pt-28 lg:pb-56"
     style={{ background: 'linear-gradient(180deg, var(--mulearn-whitish) 0%, #F0F7FF 40%, #E3F0FF 100%)'}}
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
        <div className="relative inline-block mb-6">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight max-w-3xl leading-tight">
            ...
            <br />
            <span className="text-[color:var(--mulearn-trusty-blue)]">μLearn</span>
          </h1>
        </div>
        
        {/* Curved Arrow Under μLearn */}
      ...
      <div className="absolute bottom-0 left-0 right-0 h-20 lg:h-20 overflow-visible">
        <div className="absolute inset-0 transform -skew-y-3 origin-bottom-left" >
          <div className="absolute top-0 left-0 right-0 h-8 bg-gradient-to-l from-blue-600 to-blue-100"></div>
          <div className="absolute bottom-0 left-0 right-0 h-5 bg-gradient-to-l from-blue-600 to-blue-100"></div>
        </div>
