...
export function CommunityPartnersView() {
  return (
    <div className="flex flex-col items-center justify-center md:ml-3 md:mr-3 xl:ml-0 xl:mr-0 lg:ml-0 lg:mr-0 min-h-screen">
      <div className="flex flex-col md:flex-row items-center justify-around w-full ">
        ...
        >
          <h1 className="inline-block xl:inline-block lg:inline-block md:hidden md:w-[50%] mt-10">
          ...
          <p className="mt-6 md:mt-8 text-lg md:text-2xl w-full md:mx-0 text-mulearn-gray-600">
            When a group of like-minded people come together interesting things take place. What if
            multiple Communities join their hands together for a common aim things get much more
            interesting!
          </p>
        </MotionDiv>
      ...
      <div className="max-w-7xl xl:w-7xl sm:mt-24 md:mt-32 lg:mt-32 xl:mt-0 pb-20">
        ...
        >
          <h4 className="text-3xl md:text-5xl lg:ml-10 xl:ml-0 font-semibold">
            <span className="text-mulearn">Community</span> Partners
          </h4>

          <p className="mt-6 md:mt-8 lg:ml-10 xl:ml-0 text-lg md:text-2xl md:mx-0 xl:w-176 text-mulearn-gray-600">
            µLearn has partnered with multiple communities to provide the peers the best resources
            and events to learn and up-skill themselves.
          </p>
        </MotionDiv>
